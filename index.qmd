...
---
title: "Invest Atlanta KPI Dashboard"
subtitle: "Data last updated 5/17/24"
format: 
  dashboard:
    theme: cerulean 
project:
...
sb_inv <- data.frame(name = c("2024 YTD", "2024 Goal"), inv = c(3476937, 6000000))

sb_support <- data.frame(name = c("2024 YTD", "2024 Goal"), support = c(571, 1500))

sb_ta <- data.frame(name = c("2024 YTD", "2024 Goal"), hours = c(746.6, 2750))
...
nb_dn <- data.frame(name = c("2024 YTD", "2024 Goal"), inv = c(61.5, 50))
...
nbres_plot
```
![](TAD_Approvals_2024v1.png){width=85%}
...
hs_ho <- data.frame(name = c("2024 YTD", "2024 Goal"), support = c(61, 175))
...
biz_dev <- data.frame(name = c("2024 YTD", "2024 Goal"), closed = c(16, 30))

new_jobs <- data.frame(name = c("2024 YTD", "2024 Goal"), jobs = c(1555, 5000))

good_jobs <- data.frame(name = c("2024 YTD", "2024 Goal"), good = c(1229, 1500))
...
tot_inv <- data.frame(name = c("2024 YTD", "2024 Goal"), inv = c(277943747.69, 1487100000))

ce_events <- data.frame(name = c("2024 YTD", "2024 Goal"), people = c(3754, 9000))
...
![](2024_jan-apr_wins.png){width=94%}
